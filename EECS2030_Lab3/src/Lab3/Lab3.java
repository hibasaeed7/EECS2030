...
public final class Lab3 {
	...
	public static String getSubstring(String str, char open, char close) {
		...
		//return helperfunction(str,str.indexOf(open),str.indexOf(close));
	    ...
	    return getSubstring(str.substring(1, str.length() - 1),open,close);

			
	}
	
	/*
	public static String helperfunction(String str, int open, int close)
	{
		if(open+1<close)
		{
			return str.charAt(open+1)+ helperfunction(str,open+1,close);
		}
		else 
			return "";
	}
